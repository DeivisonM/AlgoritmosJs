...
LA = parseInt(prompt("Por favor ingrese el valor del lateral izquierdo  "));
LB = parseInt(prompt("Por favor ingrese el valor del lateral derecho"));
LC = parseInt(prompt("Por favor ingrese el valor de la base "));
...
// saber cuantos kilometros debo correr dependiendo la cantidaad de calorias que consumi  con un rango de 0 a 1968 
  function Calorias() {
     var caloria = 0;
      var km = 0;
      var caloria = parseInt(prompt("Ingrese la cantidad de calorias que consumió con un rango desde 0 hasta 1968"));
  ...
  function TrueFalse() {
     var edad = 0;
     edad = parseInt(prompt("Ingrese su edad para saber si ingresa a la discoteca"))
...
function zapatos(){
 ...
 if (a<2){
    ...
    function edades(){
        var e=0;
        e = parseInt(prompt("Ingrese la edad a consultar para determinar si es un niño, adolescente, adulto o adulto mayor"));
    ...
    function areaCiruculo() {
        var a= 0;
        var r= 0;
         r = parseInt(prompt("Ingrese el radio del circulo para determinar su Area"));
